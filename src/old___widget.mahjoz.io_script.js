!(function () {
  ...
  // Получить все скрипты на странице
  var scripts = document.getElementsByTagName('script');
  var myScript;

  // Перебрать все скрипты и найти нужный
  for(var i = 0; i < scripts.length; i++) {
      var url = new URL(scripts[i].src);
      var params = new URLSearchParams(url.search);

      // Если параметр 'button_text' присутствует в URL скрипта,
      // присвоить этот скрипт переменной myScript
  ...
  if(myScript) {
      // Получить полный URL скрипта
      var scriptSrc = myScript.src;

      // Создать URL объект из URL скрипта
      var url = new URL(scriptSrc);

      // Использовать URLSearchParams для получения параметров
      var params = new URLSearchParams(url.search);

      // Теперь вы можете получить параметры:
      var urlParam = params.get('url'); // "https://albaher.mahjoz.net"
      var buttonText = params.get('button_text'); // "BookMe"
      var buttonTextColor = params.get('button_text_color'); // "%23ffff"
      var buttonBackgroundColor = params.get('button_backgroud_color'); // "%230000"

      // Если цвета передаются в процентном кодировании, вы можете декодировать их:
      ...
      console.log(urlParam, buttonText, buttonTextColor, buttonBackgroundColor);
      ...
      window.onload = function() {
        ...
        // (new w(t, e, n)).show();
        document.querySelectorAll('.mahjoz-badge-content').forEach(button => {
            button.addEventListener('click', event => {
                ...
                // Задать его свойства
                iframe.src = "https://albaher.mahjoz.net/?embed_domain=widget.mahjoz.io&embed_type=PopupWidget&embeded=1";
                iframe.width = "100%";
                iframe.height = "100%";
      ...
      console.log('Script with "button_text" parameter not found');
  }
...
//           !this.parent)
//         )
//           throw new Error("Mahjoz: Parent element not set");
//         if (
...
//           !this.url)
//         )
//           throw new Error("Mahjoz: Widget URL not set");
//       }
//       build() {
...
//         }
//         this.parent.className += " mahjoz-mobile";
//       }
//       buildSpinner() {
//         const t = document.createElement("div");
//         return (
//           (t.className = "mahjoz-spinner"),
...
//         return (e.className = `mahjoz-bounce${t}`), e;
//       }
//     }
//     class s {
//       constructor(t) {
...
//           (this.widget.className = "mahjoz-badge-widget"),
...
//         return (
//           (t.className = "mahjoz-badge-content"),
//           "#ffffff" === this.options.color && (t.className += " mahjoz-white"),
...
//         return (t.innerHTML = "powered by Mahjoz"), t;
//       }
//     }
//     var c = !1;
...
//           (this.url = 'https://widget.mahjoz.io/?url=https://albaher.mahjoz.net/?embeded=1&text=BookNow&Color=#0000'),
//           (this.onClose = e),
//           (this.embedType = 1),
//           (this.options = r);
//       }
...
//           (this.overlay.className = "mahjoz-overlay"),
...
//         const t = document.createElement("div");
//         return (
//           (t.className = "mahjoz-close-overlay"), (t.onclick = this.close), t
//         );
//       }
//       buildPopup() {
//         const t = document.createElement("div");
//         return (
//           (t.className = "mahjoz-popup"),
...
//         const t = document.createElement("div");
//         return (
//           (t.className = "mahjoz-popup-content"),
...
//         const t = document.createElement("div");
//         return (
//           (t.className = "mahjoz-popup-close"), (t.onclick = this.close), t
//         );
//       }
//       destroyOverlay() {
...
//       };
//     t(() => {
//       const t = document.querySelectorAll(".mahjoz-inline-widget");
...
//     });
//   })();
//   var o = (Mahjoz = "undefined" == typeof Mahjoz ? {} : Mahjoz);
...
// Добавление CSS-контента в элемент <style>
cssStyle.innerHTML = `
.mahjoz-badge-content {
  display: table-cell;
  width: auto;
  height: 45px;
  padding: 0 30px;
...
// Добавление элемента <style> в раздел <head>
